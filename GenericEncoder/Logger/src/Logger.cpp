...
namespace Logger
{
	...
	const std::array<std::string, TRACE_CLASS_MAX+1> traceClassString{"MAIN","READFILES","READFILESFROMDIRECTORY","WRITEFILESTODIRECTORY","WAVTOMP3ENCODER","LAMEWAVTOMP3ENCODER","THREADPOOL"};
}
